	...
	return (
		<>
			<div id={linkIdValue} className='h-full px-4 my-24 scroll-mt-96'>
				<div className='mx-auto grid w-full max-w-[1400px] grid-cols-1 grid-rows-4 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 '>
					<div className='relative z-0 row-span-4 px-8 py-10 bg-pa-green-3 md:px-12 lg:row-span-2'>
						<svg
							className='absolute w-3/4 m-auto opacity-50 left-1 right-1 top-1 bottom-1 -z-10 h-3/4'
							id='a'
							xmlns='http://www.w3.org/2000/svg'
							viewBox='0 0 32.27 64.46'
						>
							<path
								d='m25.29,9.57h5.57c.31,0,.56-.25.56-.56s-.25-.56-.56-.56h-5.57c-.31,0-.56.25-.56.56s.25.56.56.56Z'
								fill='#345F2A'
							/>
							<path
								d='m27.58,11.29c-.27-.15-.61-.06-.76.2-.15.27-.06.61.2.76l2.41,1.39c.09.05.18.07.28.07.19,0,.38-.1.48-.28.15-.27.06-.61-.2-.76l-2.41-1.39Z'
								fill='#345F2A'
							/>
							<path
								d='m27.3,6.8c.09,0,.19-.02.28-.07l2.41-1.39c.27-.15.36-.5.2-.76-.15-.27-.5-.36-.76-.2l-2.41,1.39c-.27.15-.36.5-.2.76.1.18.29.28.48.28Z'
								fill='#345F2A'
							/>
							<path
								d='m2.81,9.57h5.57c.31,0,.56-.25.56-.56s-.25-.56-.56-.56H2.81c-.31,0-.56.25-.56.56s.25.56.56.56Z'
								fill='#345F2A'
							/>
							<path
					...
					{images &&
						images.map((image: any, i) => (
							<div key={i} className='relative hidden row-span-1 aspect-square sm:block'>
								<Img
