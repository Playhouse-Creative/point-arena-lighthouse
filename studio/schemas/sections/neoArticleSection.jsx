  ...
  fields: [
    ...
    },
    {
      ...
      options: {
        ...
        list: [
          {title: 'Column Article: Use this for articles with less than 5 images', value: 'columnArticle', icon: ColumnArticleSectionIcon},
          {title: 'Carousel Article: Use this for articles with more than 4 images', value: 'carouselArticle', icon: ColumnArticleSectionIcon},
        ],
      },
    },
    ...
    {type: 'bodyPortableText', name: 'body'},
    {
      ...
      validation: (Rule) =>
        Rule.custom((field, context) => {
          if (context.parent.articleType === 'columnArticle' && field.length > 4) {
